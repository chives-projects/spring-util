...
import com.eagle.httpclient.factory.HttpContextFactory;
import com.eagle.httpclient.handler.EagleResponseErrorHandler;
import com.eagle.httpclient.interceptor.client.DefaultHttpClientInterceptor;
import com.eagle.httpclient.interceptor.client.HttpClientCustomizer;
import com.eagle.httpclient.interceptor.timeout.DefaultHttpTimeoutMethodInterceptor;
import com.eagle.httpclient.interceptor.timeout.HttpTimeoutCustomizer;
...
public class HttpClientAutoConfiguration implements InitializingAutoConfig {
    ...
    public RestTemplate restTemplate(ObjectProvider<HttpClientCustomizer> httpClientCustomizers, ClientHttpRequestFactory clientHttpRequestFactory, HttpClientProperties httpClientProperties) {
        ...
        //设置自定义异常处理
        restTemplate.setErrorHandler(new EagleResponseErrorHandler());
