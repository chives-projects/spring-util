package com.csc.spring.redis.original;
 ...
 * @Version: 1.0
 */
public class CustomRedisConnectionConfiguration {
    private static final boolean COMMONS_POOL2_AVAILABLE = ClassUtils.isPresent("org.apache.commons.pool2.ObjectPool",
            CustomRedisConnectionConfiguration.class.getClassLoader());

    private RedisProperties properties;

    public CustomRedisConnectionConfiguration(RedisProperties properties) {
    ...
    protected ConnectionInfo parseUrl(String url) {
        try {
            ...
            if (!"redis".equals(scheme) && !"rediss".equals(scheme)) {
                throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), MessageFormat.format("Redis地址{0}异常", url));
            }
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), MessageFormat.format("Redis地址{0}异常{1}", url, PrintExceptionInfo.printErrorInfo(ex)));
        }
    }
