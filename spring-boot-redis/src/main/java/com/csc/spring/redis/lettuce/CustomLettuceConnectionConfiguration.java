package com.csc.spring.redis.lettuce;

import com.csc.spring.redis.original.CustomRedisConnectionConfiguration;
...
public class CustomLettuceConnectionConfiguration extends CustomRedisConnectionConfiguration {
    ...
    private void customizeConfigurationFromUrl(LettuceClientConfiguration.LettuceClientConfigurationBuilder builder) {
        CustomRedisConnectionConfiguration.ConnectionInfo connectionInfo = parseUrl(getProperties().getUrl());
