 ...
 * @since 1.0.0
 */
public class EaglePropertiesPropertySourceLoader implements PropertySourceLoader {
    ...
    private List<Map<String, ?>> loadProperties(Resource resource) throws IOException {
        ...
        if (filename != null && filename.endsWith(XML_FILE_EXTENSION)) {
            ...
            List<EagleOriginTrackedPropertiesLoader.Document> documents = new EagleOriginTrackedPropertiesLoader(resource).load();
