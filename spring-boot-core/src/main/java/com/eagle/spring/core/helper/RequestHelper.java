...
import com.eagle.common.utils.reflect.ParamNameUtils;
import com.eagle.common.utils.servlet.RequestUtils;
import com.eagle.spring.core.context.ContextHolder;
import com.eagle.spring.core.servlet.DecoratorRequestWrapper;
...
public class RequestHelper {
    ...
    private static Map<String, Object> getArgs(MethodInvocation invocation, HttpServletRequest request) {
        ...
        try {
            ...
            logger.error("解析入参异常：" + ExceptionUtils.getInfo(e));
        }
    ...
    public static Map<String, Object> getParameterMap(byte[] params) throws IOException {
        try {
            ...
            return strToMap(IOUtils.toString(params, StandardCharsets.UTF_8.name()));
        }
    }
    ...
    public static Object getResponseBody(byte[] body) throws IOException {
        try {
            ...
            return IOUtils.toString(body, StandardCharsets.UTF_8.name());
        }
    }
    ...
    public static Map<String, Object> getMethodArgs(MethodInvocation invocation) {
        try {
            ...
            logger.error(ExceptionUtils.getInfo(e));
        }
        return Collections.emptyMap();
    }
