package com.eagle.spring.autoconfigure.request;

import com.eagle.common.InitializingAutoConfig;
import com.eagle.spring.autoconfigure.request.interceptor.DefaultRequestMethodInterceptor;
import com.eagle.spring.autoconfigure.request.interceptor.EagleRequest;
...
public class RequestAutoConfiguration implements InitializingAutoConfig {
    /**
