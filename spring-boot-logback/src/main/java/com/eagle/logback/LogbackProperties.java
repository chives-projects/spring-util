...
public class LogbackProperties {
     ...
     * 前缀
     */
    public static final String PREFIX = "eagle.logger";
    /**
     * 是否开启日志组件，默认：true
     */
    ...
    public static class Root {
         ...
         */
        private String pattern = "[%d{yyyy-MM-dd HH:mm:ss.SSS}] [%15.15t] [%-40.40logger{39}:%-4.4line] : %msg%n";
        /**
         * 打印到控制台的格式，带有颜色
         */
        private String patternConsole = "%d{yyyy-MM-dd HH:mm:ss.SSS} %clr(%5p) [%15.15t] %clr(%-40.40logger{39}:%4.4line){cyan} : %m%n%wEx";
        /**
    ...
    public static class Group {
         ...
         */
        private String pattern = "[%d{yyyy-MM-dd HH:mm:ss.SSS}] [%15.15thread] [%40.40logger{39}:%-4.4line] : %msg%n";
        /**
