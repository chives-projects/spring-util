...
import com.eagle.logback.core.policy.LogbackRollingPolicy;
import com.eagle.logback.domain.entity.LogbackAppender;
import com.eagle.logback.domain.entity.LogbackUrl;
...
public class LogbackRollingFileAppenderImpl extends AbstractAppender {
    ...
    protected Appender<ILoggingEvent> getAppender(Level level) {
        ...
        //设置附加器编码
        rollingFileAppender.setEncoder(LogbackEncoder.getPatternLayoutEncoder(this.getLoggerContext(), this.getPattern()));
