package com.csc.spring.common.utils.io;
...
public class FileUtils {
    ...
    public static String readRemoteFile(String url, String encoding) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), StringUtils.join("读取文件：", url, "发生异常", e));
        }
    }
    ...
    public static void write(final String filePath, final CharSequence data) {
        write(filePath, data, false, CharsetInfo.UTF8);
    }
    ...
    public static void write(final File file, final CharSequence data) {
        write(file, data, false, CharsetInfo.UTF8);
    }
    ...
    public static void write(final File file, final CharSequence data, final boolean append, final String encoding) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "写数据到指定文件异常，" + e);
        }
    }
    ...
    public static void writeLines(final String filePath, final Collection<?> lines) {
        writeLines(filePath, lines, false, CharsetInfo.UTF8);
    }
    ...
    public static void writeLines(final File file, final Collection<?> lines) {
        writeLines(file, lines, false, CharsetInfo.UTF8);
    }
    ...
    public static void writeLines(final File file, final Collection<?> lines, final boolean append, final String encoding) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "写数据异常，" + e);
        }
    }
    ...
    public static void writeLinesEnding(final String filePath, final Collection<?> lines, final String lineEnding) {
        writeLinesEnding(filePath, lines, lineEnding, false, CharsetInfo.UTF8);
    }
    ...
    public static void writeLinesEnding(final File file, final Collection<?> lines, final String lineEnding) {
        writeLinesEnding(file, lines, lineEnding, false, CharsetInfo.UTF8);
    }
    ...
    public static String readFileToString(final String filePath) {
        return readFileToString(filePath, CharsetInfo.UTF8);
    }
    ...
    public static String readFileToString(final File file) {
        return readFileToString(file, CharsetInfo.UTF8);
    }
    ...
    public static String readFileToString(final File file, final String encoding) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "读取资源异常，" + e);
        }
    }
    ...
    public static List<String> readLines(final String filePath) {
        return readLines(filePath, CharsetInfo.UTF8);
    }
    ...
    public static List<String> readLines(final File file) {
        return readLines(file, CharsetInfo.UTF8);
    }
    ...
    public static long sizeOf(final File file) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "计算文件大小异常，" + e);
        }
    }
    ...
    public static File toFile(final URL url) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "资源转换异常，" + e);
        }
    }
    ...
    public static void deleteDirectory(final File directory) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "删除资源异常，" + e);
        }
    }
    ...
    public static void forceMkdir(final File directory) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "创建目录异常，" + e);
        }
    }
    ...
    public static FileInputStream openInputStream(final File file) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "打开指定文件的FileInputStream输入流异常，" + e);
        }
    }
    ...
    public static FileOutputStream openOutputStream(final File file) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "打开指定文件的FileInputStream输出流异常，" + e);
        }
    }
    ...
    public static boolean directoryContains(final File directory, final File child) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "判定指定的父File对象是否包含子File对象异常，" + e);
        }
    }
    ...
    public static boolean contentEquals(final File file1, final File file2) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "比较文件内容异常，" + e);
        }
    }
    ...
    public static Checksum checksum(final File file, final Checksum checksum) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "校验文件数据异常，" + e);
        }
    }
    ...
    public static void cleanDirectory(final File directory) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "清空目录异常，" + e);
        }
    }
    ...
    public static void copyDirectory(final File srcDir, final File destDir, final FileFilter filter, final boolean preserveFileDate) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "复制资源异常，" + e);
        }
    }
    ...
    public static LineIterator lineIterator(final File file, final String encoding) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "获取指定文件行的Iterator迭代器异常，" + e);
        }
    }
    ...
    public static void moveDirectory(final File srcDir, final File destDir) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "移动目录异常，" + e);
        }
    }
    ...
    public static void moveFile(final File srcFile, final File destFile) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "移动文件异常，" + e);
        }
    }
