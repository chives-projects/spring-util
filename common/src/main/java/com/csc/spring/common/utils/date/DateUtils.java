...
public class DateUtils {
    ...
    public static String formatDate(String dateStr, String originalFormat, String nowFormat) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA_EXCEPTION.getCode(), "日期格式转换异常" + e);
        }
    }
    ...
    public static boolean compareTo(String firstDate, String secondDate, String format) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA_EXCEPTION.getCode(), ApplicationStatus.ILLEGAL_DATA_EXCEPTION.getMessage());
        }
    }
     ...
     * 将北京时间转换为美东时间
     */
    public static LocalDateTime parseToEasternTime(LocalDateTime dateTime) {
        if (dateTime == null) {
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA_EXCEPTION.getCode(), "时间不可以为空");
        }
        return dateTime.atZone(ZoneId.systemDefault()).withZoneSameInstant(ZoneId.of("US/Eastern")).toLocalDateTime();
    }
    ...
    public static Long dateToNum(Date date, String format) {
        if (Objects.isNull(date)) {
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), "日期参数不可以为空");
        }
    ...
    public static LocalDate numToLocalDate(Long date, String format) {
        ...
        if (String.valueOf(date).length() > 8) {
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), "数字类型日期不可以包含时间");
        }
    ...
    public static LocalDateTime numToLocalDateTime(Long date, String format) {
        ...
        if (String.valueOf(date).length() < 10) {
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), "数字类型日期必须包含时间");
        }
    ...
    public static Long strToNum(String dateStr, String originFormat, String format) {
        ...
        if (Objects.isNull(originFormat)) {
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), "原日期格式参数不可以为空");
        }
        if (Objects.isNull(format)) {
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), "目标日期格式参数不可以为空");
        }
