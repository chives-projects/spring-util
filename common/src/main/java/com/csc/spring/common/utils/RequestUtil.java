...
import com.csc.spring.common.exception.PrintExceptionInfo;
...
public class RequestUtil {
    ...
    public static HttpServletRequest getRequest() {
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_ACCESS_EXCEPTION.getCode(), PrintExceptionInfo.printErrorInfo(ex));
        }
    }
