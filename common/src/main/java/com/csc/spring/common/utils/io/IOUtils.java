...
public class IOUtils {
    ...
    public static boolean contentEquals(InputStream input1, InputStream input2) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "比较资源是否相等异常，" + e);
        }
    }
    ...
    public static String toString(final URI uri, final String encoding) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "将数据资源转换为字符串异常，" + e);
        }
    }
    ...
    public static byte[] toByteArray(final URI uri) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "资源转换为字节数组异常" + e);
        }
    }
    ...
    public static InputStream toBufferedInputStream(final InputStream input) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "资源相互转换异常，" + e);
        }
    }
    ...
    public static char[] toCharArray(final InputStream is, final Charset encoding) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "资源转换为字符数组异常" + e);
        }
    }
    ...
    public static LineIterator lineIterator(final InputStream input, final String encoding) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "获取输入流的迭代器异常，" + e);
        }
    }
    ...
    public static void write(final byte[] data, final OutputStream output) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "将数据写入输出流异常，" + e);
        }
    }
