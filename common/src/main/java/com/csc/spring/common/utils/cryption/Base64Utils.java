...
import com.csc.spring.common.utils.io.IOUtils;
...
public class Base64Utils {
    ...
    public static String encoder(String encoderStr) {
        return encoder(encoderStr, CharsetInfo.UTF8);
    }
    ...
    public static String encoder(String encoderStr, String charset) {
        try {
            if (StringUtils.isEmpty(encoderStr)) {
                throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), "编码字符串不可以为空");
            }
    ...
    public static String decoder(String decoderStr) {
        return decoder(decoderStr, CharsetInfo.UTF8);
    }
    ...
    public static String decoder(String decoderStr, String charset) {
        try {
            if (StringUtils.isEmpty(decoderStr)) {
                throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), "解码字符串不可以为空");
            }
            if (StringUtils.isEmpty(charset)) {
                charset = CharsetInfo.UTF8;
            }
    ...
    public static String urlEncoder(String encoderStr) {
        return urlEncoder(encoderStr, CharsetInfo.UTF8);
    }
    ...
    public static String urlEncoder(String encoderStr, String charset) {
        try {
            if (StringUtils.isEmpty(encoderStr)) {
                throw new BusinessException(ApplicationStatus.ILLEGAL_DATA_EXCEPTION.getCode(), "编码字符串不可以为空");
            }
            if (StringUtils.isEmpty(charset)) {
                charset = CharsetInfo.UTF8;
            }
    ...
    public static String urlDecoder(String decoderStr) {
        return urlDecoder(decoderStr, CharsetInfo.UTF8);
    }
    ...
    public static String urlDecoder(String decoderStr, String charset) {
        try {
            if (StringUtils.isEmpty(decoderStr)) {
                throw new BusinessException(ApplicationStatus.ILLEGAL_DATA_EXCEPTION.getCode(), "解码字符串不可以为空");
            }
            if (StringUtils.isEmpty(charset)) {
                charset = CharsetInfo.UTF8;
            }
    ...
    public static String mineEncoder(String encoderStr) {
        return mineEncoder(encoderStr, CharsetInfo.UTF8);
    }
    ...
    public static String mineDecoder(String decoderStr) {
        return mineDecoder(decoderStr, CharsetInfo.UTF8);
    }
    ...
    public static void encoderWrap(String filePath, String encoderStr, String charset) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION.getCode(), StringUtils.join("指定路径", filePath, "的文件不存在," + e));
        } catch (UnsupportedEncodingException e) {
            throw new BusinessException(ApplicationStatus.ILLEGAL_ARGUMENT_EXCEPTION);
        }
    }
