...
public class JSONUtils {
    ...
    public static <T> String toJSONString(T o, Include include) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA.getCode(), "JSON序列化处理异常，" + e);
        }
    }
    ...
    public static <T> T toJavaBean(String str, Class<T> responseType) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA.getCode(), "JSON转换异常，" + e);
        } catch (JsonMappingException e) {
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA.getCode(), "JSON转换对应关系异常，" + e);
        } catch (IOException e) {
    ...
    public static void writeToFilePretty(File file, Object o) {
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA.getCode(), "JSON字符串转换异常，" + e);
        } catch (IOException e) {
            throw new BusinessException(ApplicationStatus.EXCEPTION.getCode(), "IO异常，" + e);
        }
    }
    ...
    public static <T> T toObject(byte[] bytes, Class<T> responseType) {
        ...
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA.getCode(), "数据转换为对象异常，" + e);
        }
    }
    ...
    public static byte[] toByteArray(Object value) {
        ...
        try {
            ...
            throw new BusinessException(ApplicationStatus.ILLEGAL_DATA.getCode(), "对象转换为字节数组异常，" + e);
        }
    }
