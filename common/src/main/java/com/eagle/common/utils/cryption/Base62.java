...
public class Base62 {
    ...
    /**
     * create a instance by single bean pattern
     * example:Base62.getInstance().encode(str);
     */
    private static volatile Base62 singleton;
    ...
    public static Base62 getSingleton() {
        if (singleton == null) {
